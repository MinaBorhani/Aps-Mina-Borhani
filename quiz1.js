...
let person1 = {
  ...
  */
  const per=[person1,person2,person3];
  let persons =per;// Complete here
  
  let personNames = per.map(obj => {
    return obj.name;
  })
  ;// Complete here
  
  let personsYoungerThan28YearsOld = per.filter(ele => ele.age<28); // Complete here
